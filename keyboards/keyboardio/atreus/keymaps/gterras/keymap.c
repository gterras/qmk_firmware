...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_BEPO] = LAYOUT(
    FR_B, FR_EACU, FR_P, FR_O, FR_W, FR_M, FR_V, FR_D, FR_L, FR_J,
    FR_A, FR_U, FR_I, FR_E, TD(VIRG), FR_C, FR_T, FR_S, FR_R, FR_N,
    MT(MOD_LSFT, FR_K), FR_Y, FR_X, TD(DOT), FR_Z, FR_QUES, LT(_ACCENT, FR_EXLM), FR_QUOT, FR_Q, FR_G, FR_H, MT(MOD_RSFT, FR_F),
  ...
  /* RAISE Layer
    ...
    |   _  |   $  |  / \ |  < > | [ ]  |  ۣ  ||  Del | Corr |   1  |   2  |   3  |   *  |
    |------+------+------+------+------+------||------+------+------+------+------+------|
    | Ctrl | Alt  | Tab  |  Esc | Space|      ||      | Entr |      |   0  |  Alt | Ctrl |
    `-----------------------------------------'`-----------------------------------------' */
