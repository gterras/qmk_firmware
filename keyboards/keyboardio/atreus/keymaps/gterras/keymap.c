...
`-----------------------------------------'`-----------------------------------------' */
    ...
    [_BEPO] = LAYOUT(
        ...
        MT(MOD_LSFT, FR_K), FR_Y, FR_X, TD(DOT), FR_Z, FR_QUES, OSL(_ACCENT), TD(QUOTE), FR_Q, FR_G, FR_H, MT(MOD_RSFT, FR_F),
        KC_LCTRL, KC_LALT, LT(_FUNC, KC_TAB), LT(_LMACRO, KC_ESC), LT(_RAISE, KC_SPC), LT(_TILING, KC_NO), LT(_TILING, KC_NO), LT(_RAISE, KC_ENT), LT(_RMACRO, KC_NO), KC_NO, KC_LALT, KC_LCTRL ),
